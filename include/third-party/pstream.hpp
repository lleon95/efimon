...
template <typename C, typename T>
inline basic_pstreambuf<C, T>& basic_pstreambuf<C, T>::operator=(
    basic_pstreambuf&& rhs) noexcept {
  close();
 ...
 */
template <typename C, typename T>
pid_t basic_pstreambuf<C, T>::getpid() {
  return ppid_;
}
 ...
 */
template <typename C, typename T>
typename basic_pstreambuf<C, T>::int_type basic_pstreambuf<C, T>::overflow(
    int_type c) {
  if (!empty_buffer())
 ...
 */
template <typename C, typename T>
typename basic_pstreambuf<C, T>::int_type basic_pstreambuf<C, T>::pbackfail(
    int_type c) {
 ...
 */
template <typename C, typename T>
inline pid_t pstream_common<C, T>::getpid() {
  return buf_.getpid();
}
...
template <typename C, typename T>
inline int pstream_common<C, T>::close() {
